...
class partial_GridRow_d845aebfbcf269ea7f98a36e13e0fee24e083c86 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array7 = array();
$array8 = array (
);$array7['0'] = $renderingContext->getVariableProvider()->getByPath('element.properties.elementClassAttribute', $array8);
...
$array10 = array (
);$arguments5['then'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('element.properties.elementClassAttribute', $array10)]);
...
$arguments15 = array();
$arguments15['element'] = NULL;
$array17 = array (
);$arguments15['element'] = $renderingContext->getVariableProvider()->getByPath('element', $array17);

$output14 .= TYPO3\CMS\Form\ViewHelpers\GridColumnClassAutoConfigurationViewHelper::renderStatic($arguments15, $renderChildrenClosure16, $renderingContext);
...
$output14 .= TYPO3Fluid\Fluid\ViewHelpers\RenderViewHelper::renderStatic($arguments18, $renderChildrenClosure19, $renderingContext);
...
$array13 = array (
);$arguments11['each'] = $renderingContext->getVariableProvider()->getByPath('element.elements', $array13);
