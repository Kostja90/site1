...
class partial_List_TerTable_b78e614e520d04560b9e0d5f0772b9804c893a67 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments19 = array();
$arguments19['needle'] = NULL;
$arguments19['haystack'] = NULL;
$array21 = array (
);$arguments19['needle'] = $renderingContext->getVariableProvider()->getByPath('extension.extensionKey', $array21);
$array22 = array (
);$arguments19['haystack'] = $renderingContext->getVariableProvider()->getByPath('availableAndInstalled', $array22);

$output18 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3\CMS\Extensionmanager\ViewHelpers\InstallationStateCssClassViewHelper::renderStatic($arguments19, $renderChildrenClosure20, $renderingContext)]);
...
$arguments23['partial'] = 'List/TerSingleLine.html';
// Rendering Array
$array25 = array();
$array26 = array (
);$array25['extension'] = $renderingContext->getVariableProvider()->getByPath('extension', $array26);
...
$array17 = array (
);$arguments15['each'] = $renderingContext->getVariableProvider()->getByPath('paginatedExtensions', $array17);
